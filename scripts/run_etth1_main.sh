#!/bin/bash
# ETTh1 Full Pipeline: Train → 100-mask Eval → Results Summary
...
# ============================================================
echo "============================================================"
echo "ETTh1 [1/3] Training: $TOTAL runs"
...
echo ""
echo "============================================================"
echo "ETTh1 [1/3] Training complete!"
echo "============================================================"
...
echo ""
echo "============================================================"
echo "ETTh1 [2/3] 100-mask Evaluation"
echo "============================================================"

bash scripts/eval_all.sh --dataset ETTh1 --cpu

echo ""
echo "============================================================"
echo "ETTh1 [2/3] Evaluation complete!"
echo "============================================================"
...
echo ""
echo "============================================================"
echo "ETTh1 [3/3] Results Summary"
echo "============================================================"
...
print(f\"\"\"
{'='*70}
ETTh1 Results Summary (100-mask, 10-seed)
{'='*70}
...
output = {
    'description': 'RQ1 ETTh1 4-row bound comparison (Row 3 & 4)',
    'dataset': 'ETTh1',
...
print(f\"\"\"\n{'='*70}\nSaved to experiments/results/RQ1_ETTh1.json\n{'='*70}\"\"\")
"

echo ""
echo "============================================================"
echo "ETTh1 Full Pipeline Complete!"
echo "============================================================"
